                            ...
                            <form method="post" action="" class="mt-5 mb-5 login-input">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        ...
                                        ?>
                                        <div class="mt-4">
                                            <button type="submit" name="submitTeacher" class="btn login-form__btn submit w-100">Submit</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-4 text-left mt-2">
                                    <span class="card-title text-black font-weight-semi-bold ">Teachers Detail</span>
                                </div>
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        foreach ($result as $row){
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['gender'] ?></td>
                                                <td>
                                                    <a  href="teacher.php?type=delete&id=<?php echo $row["id"]; ?>" type="button" class="btn btn-danger mb-1 btn-rounded btn-info btn-sm">delete</a>
                                                    <a href="teacher.php?type=edit&id=<?php echo $row["id"] ?>" type="button" class="btn btn-warning mb-1 btn-rounded btn-info btn-sm">edit</a>
